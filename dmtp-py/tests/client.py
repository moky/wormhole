...
class DmtpClient(Client, PorterDelegate, Logging):
...
async def main():
    ...
    Log.warning('DMTP client %s -> %s starting ...' % (local_address, remote_address))
    ...
    Log.warning('DMTP client %s -> %s stopped.' % (local_address, remote_address))
